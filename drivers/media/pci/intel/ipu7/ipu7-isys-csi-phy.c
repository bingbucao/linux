...
static void ipu7_isys_csi_ctrl_enable(struct ipu7_isys *isys, u32 id)
{
	struct device *dev = &isys->adev->auxdev.dev;
...
static void ipu7_isys_csi_ctrl_disable(struct ipu7_isys *isys, u32 id)
{
	struct device *dev = &isys->adev->auxdev.dev;
...
int ipu7_isys_csi_phy_powerup(struct ipu7_isys_csi2 *csi2)
{
	...
	ipu7_isys_csi_ctrl_enable(isys, id);
...
void ipu7_isys_csi_phy_powerdown(struct ipu7_isys_csi2 *csi2)
{
	...
	return ipu7_isys_csi_ctrl_disable(isys, csi2->port);
