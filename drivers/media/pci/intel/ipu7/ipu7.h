...
#define IPU_DMA_MASK			32
#define IPU_LIB_CALL_TIMEOUT_MS		20000
#define IPU_PSYS_CMD_TIMEOUT_MS		(30 * 1000)
#define IPU_PSYS_OPEN_CLOSE_TIMEOUT_US	50
#define IPU_PSYS_OPEN_CLOSE_RETRY	20000
